...
function icon_map() {
  ...
  "Fusion")
    icon_result=":fusion:"
    ;;
  "System Preferences" | "System Settings" | "系統設置" | "Réglages Système")
    icon_result=":gear:"
    ;;
  "GitHub Desktop")
    icon_result=":git_hub:"
  ...
  "Logseq")
    icon_result=":logseq:"
    ;;
  "Canary Mail" | "HEY" | "Mail" | "Mailspring" | "MailMate" | "Superhuman" | "Spark" | "郵件")
    icon_result=":mail:"
    ;;
  "MAMP" | "MAMP PRO")
    icon_result=":mamp:"
  ...
  "Parsec")
    icon_result=":parsec:"
    ;;
  "Preview" | "預覧" | "Skim" | "zathura" | "Aperçu")
    icon_result=":pdf:"
    ;;
  "PDF Expert")
  ...
  "Royal TSX")
    ...
    ;;
  "Safari" | "Safari瀏覧器" | "Safari Technology Preview")
    icon_result=":safari:"
    ;;
  "Sequel Ace")
